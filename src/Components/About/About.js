    ...
    <section className="about section">
      <div className="secContainer">
        ...
        <div className="mainContent container grid">
          ...
          {/* 1 */}
          <div data-aos='fade-right' data-aos-duration='3000' className="singleItem">
            <PiMountainsFill className='icons' />
            {/* <img src={img2} alt="Image Name" /> */}
            <h3>100+ Mountains</h3>
            <p>
              Research shows that a chance away from the normal rhythms of daily life reduces stress and imporves health and  well-being.
            </p>
          </div>

          {/* 2 */}
          <div data-aos='fade-down' data-aos-duration='3000' className="singleItem">
          ...
          {/* 3 */}
          <div data-aos='fade-left' data-aos-duration='3000' className="singleItem">
        ...
        <div className="videoCard container">
          <div className="cardContent grid">
            <div data-aos='fade-right' data-aos-duration='3000' className="cardText">
              ...
              <p>The Adventure subranking is based on an eqally weighted average of scores from five country.</p>
            </div>
